...
alpha1_dot_min = -(360*math.pi/180)/30; alpha1_dot_max = (360*math.pi/180)/30               # azimuth thruster max turnaround time (rad/s) ------------------------------CHECK THIS-------------------------------------------
alpha2_dot_min = -(360*math.pi/180)/30; alpha2_dot_max = (360*math.pi/180)/30
...
U = ca.vertcat(f_thr,alpha,alpha_dot)             # NLP input vector

x_init = [150,-325,-math.pi, 0,0,0, 0,0,0]     # x(0)=150, y(0)=-325, psi(0)=-pi, u(0)=0, v(0)=0, r(0)=0
u_init = [0,0,0, 0,0, 0,0]
u_min = [f1_min,f2_min,f3_min, alpha1_min,alpha2_min, alpha1_dot_min,alpha2_dot_min]
u_max = [f1_max,f2_max,f3_max, alpha1_max,alpha2_max, alpha1_dot_max,alpha2_dot_max]
